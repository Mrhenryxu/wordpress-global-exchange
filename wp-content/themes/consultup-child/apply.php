    ...
    <div class="container">
        ...
        if (empty(session::get('loginemail'))&empty(session::get('loginpassword') )){
                ...
                $password=$_POST['password'];
                            ...
                            $fromemail=session::get('loginemail');
                                ...
                                echo"
                                    <tr id=\"resulttr\">
                                        ...
                                        if($_SESSION['subject']==1){
                                            echo "STEM; ";
                                        }else if($_SESSION['subject']==2){
                                            echo "Problem-solving; ";
                                        }else if($_SESSION['subject']==3){
                                            echo "Inquiry-based learning; ";
                                        }else if($_SESSION['subject']==4){
                                            echo "Early years numeracy; ";
                                        }else if($_SESSION['subject']==5){
                                            echo "Junior maths; ";
                                        }else if($_SESSION['subject']==6){
                                            echo "Middle years maths; ";
                                        }else if($_SESSION['subject']==7){
                                            echo "Senior maths; ";
                                        }else if($_SESSION['subject']==8){
                                            echo "Maths projects; ";
                                        }else if($_SESSION['subject']==9){
                                            echo "Exam preparation; ";
                                        }else if($_SESSION['subject']==10){
                                            echo "General maths; ";
                                        }else if($_SESSION['subject']==11){
            ...
            <?php } 
                        ...
                        echo    "</table>"; 
                                        ...
                                        session::set('loginemail', $r['email'], 600);
                                        session::set('loginpassword', $r['password'], 600);

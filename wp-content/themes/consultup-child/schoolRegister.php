            ...
            <table id="resulttable">
               <tr id="resulttr">
                ...
                <tr id="resulttr">
                    ...
                    <td id="resulttd">
                        <input type="text" name="position" placeholder="Position" value="<?php echo $_SESSION['position'];?>"  required>
                    </td>
                </tr>
                <tr id="resulttr">
                    ...
                    <td id="resulttd">
                        <fieldset> 
                           <table width="500" length="100" >
                                <tr> 
                                    <td> &nbsp;<input type="checkbox" name="department[]" value="1">  STEM</td>
                                    <td><input type="checkbox" name="department[]" value="2">  Problem-solving</td>
                                    <td> <input type="checkbox" name="department[]" value="3">  Inquiry-based learning</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;<input type="checkbox" name="department[]" value="4">  Early years numeracy</td>
                                    <td><input type="checkbox" name="department[]" value="5">  Junior maths</td>
                                    <td><input type="checkbox" name="department[]" value="6">  Middle years maths</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;<input type="checkbox" name="department[]" value="7">  Senior maths</td>
                                    <td><input type="checkbox" name="department[]" value="8">  Maths projects</td>
                                    <td><input type="checkbox" name="department[]" value="9">  Exam preparation</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;<input type="checkbox" name="department[]" value="10">  General maths</td>
                                    <td><input type="checkbox" name="department[]" value="11">  Mastery approach</td>
	...
	<option value="ZW">Zimbabwe</option> -->
          ...
          if($_SESSION['hostVisiting']=="1,2"){?>
             ...
             <?php }  
                ...
                <fieldset>  
                   <table width="500" length="100" >
                       ...
                       <td> <input type="checkbox" name="accommodateMonths[]" value="11" onclick="return ValidatePetSelection();">  November</td>
                            <td> <input type="checkbox" name="accommodateMonths[]" value="12" onclick="return ValidatePetSelection();">  December</td></tr>
                    </table>
                </fieldset>
               ...
               <tr id="resulttr">
                <td id="resulttd">&nbsp;<input type="submit" value="Register"></td>
               </tr>
              </table>
